    ...
    <div className="min-h-screen bg-background">
      <div className="mx-auto max-w-5xl px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <h1 className="mb-3 text-4xl font-bold text-gray-900">Module Federation Demo</h1>
          <p className="text-lg text-gray-600">
            Demonstrating cross-app component sharing between CV Portfolio and DeFi Dashboard
          </p>
        </div>

        {/* Info Card */}
        <div className="mb-8 rounded-lg border border-blue-200 bg-blue-50 p-6">
          <h2 className="mb-3 text-lg font-semibold text-blue-900">What is Module Federation?</h2>
          <div className="space-y-2 text-sm text-blue-800">
            <p>
              Module Federation is a webpack feature that allows JavaScript applications to
              dynamically load code from other applications at runtime.
            </p>
            <p>This enables true micro-frontend architecture where each app is:</p>
        ...
        <div className="mb-8 grid gap-6 md:grid-cols-2">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-6">
            <h3 className="mb-3 font-semibold text-gray-900">DeFi Dashboard (Remote)</h3>
            <div className="space-y-2 text-sm text-gray-700">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <h2 className="mb-4 text-xl font-bold text-gray-900">Implementation Status</h2>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-orange-700">
                  Module Federation configuration is available but currently disabled due to Next.js
                  14 App Router compatibility challenges. The configuration is documented and can be
                  enabled with additional webpack setup.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Code Example */}
        <div className="rounded-lg border border-gray-200 bg-white p-6">
          <h2 className="mb-4 text-xl font-bold text-gray-900">Usage Example (When Enabled)</h2>
    ...
    <div>
      ...
      <RemotePriceTicker />
        ...
        <div className="mt-8 rounded-lg border border-yellow-200 bg-yellow-50 p-6">
          <h3 className="mb-3 font-semibold text-yellow-900">Setup Instructions</h3>
          <div className="space-y-2 text-sm text-yellow-800">
            <p>To see this demo in action:</p>
            <ol className="ml-6 list-decimal space-y-1">
              <li>
                Start CV Portfolio:{' '}
                <code className="rounded bg-yellow-100 px-1">cd apps/cv-portfolio && yarn dev</code>
              </li>
              <li>
                Start DeFi Dashboard:{' '}
                <code className="rounded bg-yellow-100 px-1">
                  cd apps/defi-dashboard && yarn dev -p 3001
                </code>
              </li>
              <li>Click &quot;Load Remote PriceTicker Widget&quot; above</li>
            </ol>
            <p className="mt-3 text-xs">
              Note: Both apps must be running simultaneously for Module Federation to work.
            </p>
          </div>
        </div>
      </div>
